...
### Integration & Testing
- [ ] Full end-to-end ComfyUI inference smoke with SDXL real prompt — validate output quality / speed & memory.
...
- [ ] Add gating for content moderation / watermark metadata before generating images for monetized features.
